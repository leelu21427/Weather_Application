...
fetch('https://api.openweathermap.org/data/2.5/forecast?q='+newName.value+'&appid=594c464a74dcfd94ef78f9bcd28d41e0' )
...
.then(data => {
    ...
    //Getting Weather Icons
     for(i = 0; i<5; i++){
        document.getElementById("img" + (i+1)).src = "https://www.tomorrow.io/weather/widget/"+
